...
from rayml.model_understanding import calculate_permutation_importance
from rayml.utils import get_logger, infer_feature_types
...
def readable_explanation(
    ...
    if importance_method == "permutation":
        ...
        if objective == "auto":
            objective = rayml.automl.get_default_primary_search_objective(
...
def _fill_template(
    ...
    if objective is not None:
        if isinstance(objective, rayml.objectives.ObjectiveBase):
