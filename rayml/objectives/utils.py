"""Utility methods for rayml objectives."""
from .objective_base import ObjectiveBase

from rayml import objectives
from rayml.exceptions import ObjectiveCreationError, ObjectiveNotFoundError
from rayml.problem_types import handle_problem_types
from rayml.utils.gen_utils import _get_subclasses
...
def _all_objectives_dict():
    ...
    for objective in all_objectives:
        if "rayml.objectives" not in objective.__module__:
            continue
...
def get_objective(objective, return_instance=False, **kwargs):
    ...
    if objective.lower() not in all_objectives_dict:
        raise ObjectiveNotFoundError(
            ...
            "Use rayml.objectives.get_all_objective_names()"
