...
from rayml.pipelines.components import ElasticNetClassifier
from rayml.pipelines.components.ensemble import StackedEnsembleBase
...
class StackedEnsembleClassifier(StackedEnsembleBase):
    ...
    Example:
        ...
        >>> from rayml.pipelines.components.estimators.classifiers.decision_tree_classifier import DecisionTreeClassifier
        >>> from rayml.pipelines.components.estimators.classifiers.elasticnet_classifier import ElasticNetClassifier
        ...
        >>> component_graph = {
