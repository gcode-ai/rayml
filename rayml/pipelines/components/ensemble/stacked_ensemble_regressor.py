...
from rayml.pipelines.components import ElasticNetRegressor
...
class StackedEnsembleRegressor(StackedEnsembleBase):
    ...
    Example:
        ...
        >>> from rayml.pipelines.components.estimators.regressors.rf_regressor import RandomForestRegressor
        >>> from rayml.pipelines.components.estimators.regressors.elasticnet_regressor import ElasticNetRegressor
        ...
        >>> component_graph = {
