"""Utility methods for rayml pipelines."""
import copy
import logging
...
from rayml.data_checks import DataCheckActionCode, DataCheckActionOption
from rayml.model_family import ModelFamily
from rayml.pipelines.components import (  # noqa: F401
    CatBoostClassifier,
    CatBoostRegressor,
    ComponentBase,
    DateTimeFeaturizer,
...
from rayml.utils import import_or_raise, infer_feature_types
...
def generate_pipeline_code(element):
    """Creates and returns a string that contains the Python imports and code required for running the rayml pipeline.
