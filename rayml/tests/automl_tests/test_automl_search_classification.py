...
from rayml.automl.callbacks import raise_error_callback
from rayml.automl.pipeline_search_plots import SearchIterationPlot
from rayml.exceptions import ParameterNotUsedWarning, PipelineNotFoundError
...
from rayml.pipelines.components.utils import get_estimators
from rayml.preprocessing import TimeSeriesSplit, split_data
...
@patch("rayml.pipelines.components.estimators.Estimator.fit")
@patch(
    "rayml.pipelines.BinaryClassificationPipeline.score",
    return_value={"Log Loss Binary": 0.5},
)
@patch(
    "rayml.pipelines.MulticlassClassificationPipeline.score",
...
@patch(
    "rayml.automl.automl_algorithm.default_algorithm.DefaultAlgorithm._create_ensemble",
    return_value=[],
)
@patch("rayml.pipelines.components.estimators.Estimator.fit")
@patch(
