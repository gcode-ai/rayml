...
from rayml.automl.automl_algorithm import DefaultAlgorithm
...
@patch("rayml.pipelines.components.FeatureSelector.get_names")
...
@patch("rayml.pipelines.components.FeatureSelector.get_names")
def test_rayml_algo_pipeline_params(mock_get_names, X_y_binary):
    X, y = X_y_binary
...
@patch("rayml.pipelines.components.FeatureSelector.get_names")
@patch("rayml.pipelines.components.OneHotEncoder._get_feature_provenance")
def test_rayml_algo_custom_hyperparameters(
