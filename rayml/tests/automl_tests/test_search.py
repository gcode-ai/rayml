...
from rayml.automl import AutoMLSearch, search
from rayml.automl.automl_algorithm import DefaultAlgorithm
from rayml.utils import infer_feature_types


@patch("rayml.data_checks.default_data_checks.DefaultDataChecks.validate")
@patch("rayml.automl.AutoMLSearch.search")
def test_search(
    mock_automl_search,
