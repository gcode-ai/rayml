...
from rayml.pipelines.components.ensemble import (
    StackedEnsembleBase,
    StackedEnsembleClassifier,
    StackedEnsembleRegressor,
)
from rayml.pipelines.components.estimators.classifiers.vowpal_wabbit_classifiers import (
    VowpalWabbitBinaryClassifier,
    VowpalWabbitMulticlassClassifier,
)
from rayml.pipelines.components.estimators.regressors.vowpal_wabbit_regressor import (
    VowpalWabbitRegressor,
)
from rayml.pipelines.components.transformers.encoders.label_encoder import (
    LabelEncoder,
)
from rayml.pipelines.components.transformers.preprocessing.log_transformer import (
    LogTransformer,
)
from rayml.pipelines.components.transformers.samplers.base_sampler import (
    BaseSampler,
)
...
def test_generate_code():
    expected_code = (
        "from rayml.pipelines.components.estimators.classifiers.logistic_regression_classifier import LogisticRegressionClassifier"
    ...
    expected_code = (
        "from rayml.pipelines.components.estimators.regressors.et_regressor import ExtraTreesRegressor"
    ...
    expected_code = (
        "from rayml.pipelines.components.transformers.imputers.imputer import Imputer"
