...
from rayml.demos import load_diabetes
from rayml.pipelines.components import DFSTransformer
...
@patch("rayml.pipelines.components.transformers.preprocessing.featuretools.dfs")
@patch(
    "rayml.pipelines.components.transformers.preprocessing.featuretools.calculate_feature_matrix"
)
