...
from rayml.pipelines import LightGBMClassifier
...
@patch("rayml.pipelines.components.estimators.estimator.Estimator.predict_proba")
@patch("rayml.pipelines.components.estimators.estimator.Estimator.predict")
