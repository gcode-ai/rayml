...
@pytest.mark.parametrize("problem_type", [ProblemTypes.BINARY, ProblemTypes.MULTICLASS])
@patch("rayml.pipelines.components.ensemble.StackedEnsembleClassifier.fit")
...
@patch("rayml.pipelines.components.StackedEnsembleClassifier.fit")
@patch("rayml.pipelines.components.ElasticNetClassifier.fit")
