...
from rayml.pipelines import RegressionPipeline
...
from rayml.pipelines.components.ensemble import StackedEnsembleRegressor
from rayml.pipelines.utils import _make_stacked_ensemble_pipeline
...
@patch("rayml.pipelines.components.ensemble.StackedEnsembleRegressor.fit")
...
@patch("rayml.pipelines.components.StackedEnsembleRegressor.fit")
@patch("rayml.pipelines.components.ElasticNetRegressor.fit")
@patch("rayml.pipelines.components.RandomForestRegressor.fit")
@patch("rayml.pipelines.components.ElasticNetRegressor.predict_proba")
@patch("rayml.pipelines.components.RandomForestRegressor.predict_proba")
