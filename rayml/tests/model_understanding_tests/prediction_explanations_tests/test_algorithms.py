...
from rayml.model_family.model_family import ModelFamily
from rayml.model_understanding.prediction_explanations._algorithms import (
...
from rayml.pipelines.components.utils import _all_estimators_used_in_search
from rayml.pipelines.utils import make_pipeline
from rayml.problem_types.problem_types import ProblemTypes
...
@patch(
    "rayml.model_understanding.prediction_explanations._algorithms.shap.TreeExplainer"
)
...
def test_lime_xgboost(X_y_multi):
    ...
    from rayml.pipelines.components import XGBoostClassifier
...
@patch("rayml.model_understanding.prediction_explanations._algorithms.logger")
