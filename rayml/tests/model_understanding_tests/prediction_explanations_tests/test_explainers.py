...
from rayml.model_understanding.prediction_explanations.explainers import (
...
from rayml.problem_types import ProblemTypes, is_binary, is_multiclass
...
@patch("rayml.model_understanding.prediction_explanations.explainers.DEFAULT_METRICS")
@patch(
    "rayml.model_understanding.prediction_explanations._user_interface._make_single_prediction_explanation_table"
)
