...
from rayml.model_understanding.force_plots import force_plot, graph_force_plot
from rayml.pipelines import (
    BinaryClassificationPipeline,
    MulticlassClassificationPipeline,
    RegressionPipeline,
)
from rayml.tests.model_understanding_tests.prediction_explanations_tests.test_explainers import (
    pipeline_test_cases,
...
@patch("rayml.model_understanding.force_plots.jupyter_check")
@patch("rayml.model_understanding.force_plots.initjs")
