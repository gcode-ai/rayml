...
from rayml.model_understanding.prediction_explanations._user_interface import (
...
@patch(
    "rayml.model_understanding.prediction_explanations._user_interface._BinaryExplanationTable.make_text"
)
@patch(
    "rayml.model_understanding.prediction_explanations._user_interface._compute_lime_values"
)
@patch(
    "rayml.model_understanding.prediction_explanations._user_interface._compute_shap_values"
)
