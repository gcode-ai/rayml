...
from rayml.model_understanding import (
...
@patch(
    "rayml.model_understanding.feature_explanations.calculate_permutation_importance"
)
...
@patch("rayml.pipelines.PipelineBase.feature_importance", new_callable=PropertyMock)
