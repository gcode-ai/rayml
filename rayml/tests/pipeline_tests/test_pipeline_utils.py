...
from rayml.data_checks import DataCheckAction, DataCheckActionCode
...
from rayml.problem_types import ProblemTypes, is_time_series
...
def test_generate_code_pipeline_json_with_objects():
    ...
    assert (
        ...
        == "from rayml.pipelines.binary_classification_pipeline import BinaryClassificationPipeline\n"
