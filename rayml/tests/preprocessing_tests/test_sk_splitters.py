...
from rayml.preprocessing.data_splitters import KFold, StratifiedKFold
...
def test_splitters_equal(problem_type, sk_splitter, splitter, X_y_binary, X_y_multi):
    ...
    rayml_split = splitter(**parameters)
