...
from rayml.tuners import ParameterError, Tuner
from rayml.tuners.skopt_tuner import SKOptTuner
...
def test_skopt_tuner_invalid_parameters_score():
    ...
    with patch("rayml.tuners.skopt_tuner.Optimizer.tell") as mock_optimizer_tell:
